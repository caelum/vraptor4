...
final class PackageComparator implements Comparator<Serialization> {
	private int number(Serialization s) {
		...
		if (packageName.startsWith("br.com.caelum.vraptor4.serialization")
		 || packageName.startsWith("br.com.caelum.vraptor4.restfulie.serialization")) {
			return 1;
		}
		return 0;
	}
	...
	private int giveMorePriorityToRestfulie(Serialization o1, Serialization o2) {
		...
		if(packageNameO1.startsWith("br.com.caelum.vraptor4.serialization")
		&& packageNameO2.startsWith("br.com.caelum.vraptor4.restfulie.serialization")) {
			return 1;
		} else if (packageNameO2.startsWith("br.com.caelum.vraptor4.serialization")
		&& packageNameO1.startsWith("br.com.caelum.vraptor4.restfulie.serialization")){
			return -1;
		}
