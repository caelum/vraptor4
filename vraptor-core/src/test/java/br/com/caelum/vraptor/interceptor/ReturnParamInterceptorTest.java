...
public class ReturnParamInterceptorTest {
	...
	@Test
	public void shoulReturnParamsToView() throws Exception {

		ReturnParamInterceptor returnParamInterceptor =
			new ReturnParamInterceptor(info, result, nameProvider, controllerMethod);
