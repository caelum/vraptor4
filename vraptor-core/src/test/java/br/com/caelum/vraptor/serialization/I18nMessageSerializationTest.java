...
public class I18nMessageSerializationTest {
	...
	public void setup() throws Exception {
		...
		GsonSerializerBuilder gsonBuilder =  new GsonBuilderWrapper(new MockInstanceImpl<>(jsonSerializers), new MockInstanceImpl<>(jsonDeserializers), new MockInstanceImpl<>(new Serializee()));
