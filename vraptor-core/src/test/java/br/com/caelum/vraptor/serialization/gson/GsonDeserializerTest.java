...
public class GsonDeserializerTest {
	...
	@Test
	public void shouldNotAcceptMethodsWithoutArguments() {
	...
	@Test
	public void shouldBeAbleToDeserializeADog() throws IOException {
		try (InputStream stream = asStream("{'dog':{'name':'Brutus','age':7}}")) {
	...
	@Test
	public void shouldBeAbleToDeserializeADogWithoutRootAndParameterNameEqualsJsonProperty() throws IOException {
		try (InputStream stream = asStream("{'name':'Brutus','age':7}")) {
	...
	@Test
	public void shouldBeAbleToDeserializeADogWithoutRoot() throws IOException {
		try (InputStream stream = asStream("{'name':'Brutus','age':7}")) {
	...
	@Test
	public void shouldBeAbleToDeserializeADogWithDeserializerAdapter() throws IOException {
		...
		try (InputStream stream = asStream("{'dog':{'name':'Renan Reis','age':'0'}}")) {
			Object[] deserialized = deserializer.deserialize(stream, dogParameter);
	...
	@Test
	public void shouldBeAbleToDeserializeADogWhenMethodHasMoreThanOneArgument() throws IOException {
		try (InputStream stream = asStream("{'dog':{'name':'Brutus','age':7}}")) {
	...
	@Test
	public void shouldBeAbleToDeserializeADogWhenMethodHasMoreThanOneArgumentAndJsonIsTheLastOne() throws IOException {
		try (InputStream stream = asStream("{'dog':{'name':'Brutus','age':7}}")) {
	...
	@Test
	public void shouldBeAbleToDeserializeADogNamedDifferently() throws IOException  {
		try (InputStream stream = asStream("{'dog':{'name':'Brutus','age':7}}")) {
			Object[] deserialized = deserializer.deserialize(stream, dogParameter);
	...
	public void shouldHonorRequestHeaderAcceptCharset() throws Exception {
		try (InputStream stream = asStream("{'dog':{'name':'̤'}}", StandardCharsets.ISO_8859_1)) {
	...
	@Test
	public void shouldBeAbleToDeserializeADogWhenMethodHasMoreThanOneArgumentAndHasNotRoot() throws IOException {
		try (InputStream stream = asStream("{'name':'Brutus','age':7}")) {
			Object[] deserialized = deserializer.deserialize(stream, dogAndIntegerParameter);
	...
	@Test
	public void shouldDeserializeFromGenericTypeOneParam() throws IOException {
		try (InputStream stream = asStream("{'entity':{'name':'Brutus','age':7,'birthday':'2013-07-23T17:14:14-03:00'}}")) {
	...
	@Test
	public void shouldDeserializeFromGenericTypeWithoutRoot() throws IOException {
		try (InputStream stream = asStream("{'name':'Brutus','age':7,'birthday':'2013-07-23T17:14:14-03:00'}")) {
			BeanClass resourceClass = new DefaultBeanClass(DogGenericController.class);
			Method method = new Mirror().on(DogGenericController.class).reflect().method("method").withAnyArgs();
			ControllerMethod resource = new DefaultControllerMethod(resourceClass, method);
	...
	@Test
	public void shouldDeserializeADogWithCalendarWithISO8601() throws IOException {
		try (InputStream stream = asStream("{'dog':{'name':'Otto','age':2,'birthday':'2013-07-23T17:14:14-03:00'}}")) {
			Object[] deserialized = deserializer.deserialize(stream, dogParameter);
	...
	@Test
	public void shouldDeserializeADateWithISO8601() throws IOException {
		try (InputStream stream = asStream("{\"date\":\"1988-02-25T02:30:15 -0300\"}")) {
