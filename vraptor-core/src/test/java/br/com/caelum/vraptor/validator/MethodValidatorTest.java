...
public class MethodValidatorTest {
	...
	public void shouldAcceptIfMethodHasConstraint() {
		...
		getMethodValidator().validate(new EndOfInterceptorStack(withConstraint, instance), controller, methodInfo, validator);
	...
	public void shouldNotAcceptIfMethodHasConstraint() {
		DefaultControllerInstance controller = spy(instance);
		getMethodValidator().validate(new EndOfInterceptorStack(withoutConstraint, instance), controller, methodInfo, validator);
	...
	public void shouldValidateMethodWithConstraint() throws Exception {
		...
		getMethodValidator().validate(new EndOfInterceptorStack(withConstraint, instance), instance, methodInfo, validator);
