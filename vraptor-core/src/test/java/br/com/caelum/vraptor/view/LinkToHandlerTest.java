...
public class LinkToHandlerTest {
	...
	public void shouldAvoidFrozenClassIfTwoVRaptorInstancesAreLoaded() throws Throwable {
		...
		when(context0.getContextPath()).thenReturn("instance0");
		when(context1.getContextPath()).thenReturn("instance1");
		...
		assertThat(object0.getClass().getName(), containsString("instance0"));

		Object object1 = handler1.get(new DefaultBeanClass(TestController.class));
		assertThat(object1.getClass().getName(), containsString("instance1"));
	}
